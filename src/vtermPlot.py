...
tf=r.TFile("vterm.root") # open file for read access
if tf.IsZombie():
    print("vterm.root not found in current directory, run vterm first")
    sys.exit(1)
...
tc.Print("vterm.png") # or use Projectile.png, etc. to save your canvas
